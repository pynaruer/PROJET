...
if __name__ == "__main__":
    ...
    app = QApplication([])
    window_1 = Entry_Box()
    color = window_1.palette()
    color.setColor(window_1.backgroundRole(), QColor(130,214,246))
    window_1.setPalette(color)
    window_1.show()
    app.exec_()
    ...
    if window_1.getNumber() == 1:
        ...
        col = window_2.palette()
        col.setColor(window_2.backgroundRole(), QColor(130,214,246))
        window_2.setPalette(col)
        window_2.show()
        app.exec_()
        sys.exit()
